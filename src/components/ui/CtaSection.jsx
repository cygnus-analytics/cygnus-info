    ...
    <section className="">
      ...
      <h2 className="mb-4 text-3xl sm:text-4xl md:text-5xl font-bold">
          ...
          <div className="flex flex-col space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4">
              <Link
                href={ctaLink}
                className=" lg:block text-white bg-gradient-to-r from-blue-500 via-blue-700 to-blue-900 hover:bg-gradient-to-br shadow-lg shadow-blue-500/50 font-medium rounded-3xl text-sm px-5 py-3 text-center"
              >
                {ctaText}
              </Link>
            </div>
