...
export default function CaseStudiesCard({ card, relatedCaseStudies }) {
  return (
    <div className="mx-auto bg-white pb-24">
      ...
      <div className="relative w-full">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <h1 className="text-center text-white font-bold text-2xl sm:text-3xl md:text-4xl uppercase tracking-wide leading-tight px-4">
            {card.heading}
          </h1>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-5xl flex flex-col py-12 gap-y-12 px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 justify-items-center">
            {relatedCaseStudies.map((randomCard, index) => (
              <Link
              ...
              >
                <motion.div
                  ...
                  style={{ backgroundImage: `url(${randomCard.image})` }}
